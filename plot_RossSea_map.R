...
# MVP track
setwd("C:/Users/greenanb/Documents/Science Projects/Current/Ross Sea/Documents/Papers/Ross Bank/Figures/MVP")
######## Load the Rdata file
load("MVP.RData")
...
# Ross Bank Survey
Start_time <- as.POSIXct("2012-01-20", tz="UTC")
End_time <- as.POSIXct("2012-01-23 03:00:00", tz="UTC")
...
basemap(shapefiles = list(land = bs_land, glacier = bs_ice_shelves, bathy = bs_bathy, 
  ...
  geom_spatial_point(data = dt3, aes(x = MVP_lon, y = MVP_lat), color = "green", size = 0.01) +  
